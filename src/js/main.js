...
window.addEventListener('DOMContentLoaded', function() {
   ...
   //modal
    ...
    const openModalBtn = document.querySelectorAll('[data-modal]'),
          ...
          closModalsBtn = document.querySelector('[data-close]');

          function openModal() {
            modals.classList.add('show');
            modals.classList.remove('hide');
            document.body.style.overflow = 'hidden';
            clearTimeout(taimModals);
          }
          ...
          closModalsBtn.addEventListener('click', closModals);
          ...
          const taimModals = setTimeout(openModal, 2000);
        ...
        //forms
         ...
         const message = {
            ...
            success: 'Отлично! Скоро мы вам перезвоним',
         ...
         function postData(form) {
            ...
            form.addEventListener('submit', (e) => {
                ...
                .then(data => {
                    console.log(data);
                    showTasksModal(message.success);
                })
                .catch(() => {
                    showTasksModal(message.failure);
                })
                .finally(() => {
                    form.reset();
                });
        ...
        function showTasksModal(message) {
