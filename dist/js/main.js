...
window.addEventListener('DOMContentLoaded', () => {
  ...
  setClock('.timer', deadline); //modals
  ...
  modalCloseBtn.addEventListener('click', modalsClose); //const timeModals = setTimeout(modalsOpen, 3000);
  ...
  window.addEventListener('scroll', showModlByScroll); // menu карточки 
